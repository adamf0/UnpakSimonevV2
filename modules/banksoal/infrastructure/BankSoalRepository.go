...
import (
	commondomainbanksoal "UnpakSiamida/common/domain"
...
func (r *BankSoalRepository) GetDefaultByUuid(
	...
	// Ambil hanya kolom yang benar-benar ada di struct BankSoalDefault
	var rowData domainbanksoal.BankSoalDefault
...
func (r *BankSoalRepository) GetAll(
	ctx context.Context,
	search string,
	searchFilters []commondomainbanksoal.SearchFilter,
	page, limit *int,
	deleted bool,
