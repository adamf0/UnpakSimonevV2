...
func CreateTemplatePertanyaanCommandValidation(cmd CreateTemplatePertanyaanCommand) error {
	return validation.ValidateStruct(&cmd,
		...
		validation.Field(&cmd.JenisPilihan,
			...
			// validation.In("radio", "checkbox", "rating5").Error("Invalid jenis pilihan"),
		),
